                            ...
                            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="book_appoint" class="form-control" placeholder="Book Appointment Link">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="about_us" class="form-control" placeholder="About Us Link">
