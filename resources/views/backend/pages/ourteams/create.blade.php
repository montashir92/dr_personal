        ...
        <div class="col-md-12">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">
                    <i class="fa fa-plus"></i> Add New Our Team
                        ...
                        <div class="col-xl-12">
                            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="designation" class="form-control" placeholder="Team Member Designation">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="facebook" class="form-control" placeholder="Facebook Address">
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="twitter" class="form-control" placeholder="Twitter Address">
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="instagrm" class="form-control" placeholder="Instagram Address">
                                    </div>
                                </div>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-7 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="youtube" class="form-control" placeholder="Youtube Address">
                                    </div>
                                </div>
