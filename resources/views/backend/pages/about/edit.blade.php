        ...
        <div class="col-md-12">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">
                    <i class="fa fa-edit"></i> Update About
                    <a href="{{ route('admin.abouts') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-list"></i> All About</a>
                </h6>
                    ...
                    <div class="row row-sm mg-t-20">
                        <div class="col-xl-12">
                            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                ...
                                <div class="row">
                                    <label class="col-sm-3 form-control-label">About Title <span class="tx-danger">*</span></label>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <textarea class="form-control" name="description" rows="4" id="summernote2" placeholder="Product Long Description">
                                        {{ $about->description }}
                                        </textarea>
                                ...
                                <div class="row mg-t-20">
                                    <label class="col-sm-3 form-control-label">About Image: <span class="tx-danger">*</span></label>
                                    ...
                                    <div class="col-sm-2">
                                        <img src="{{ asset($about->image) }}" width="100" id="mainThmb">
                                    </div>
                                </div>
