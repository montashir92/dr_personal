        ...
        <div class="col-md-12">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">
                    <i class="fa fa-plus"></i> Update Latest Case
                    ...
                    <div class="row row-sm mg-t-20">
                        <div class="col-xl-12">
                            <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                <form action="{{ route('admin.lastestcase.update', $lastest->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    
                                    <input type="hidden" name="old_image" value="{{ $lastest->image }}">
                                <div class="row">
                                    <label class="col-sm-3 form-control-label">Name <span class="tx-danger">*</span></label>
                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                        <input type="text" name="name" value="{{ $lastest->name }}" class="form-control" placeholder="Case Name">
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                        <select name="casecat_id" class="form-control select2-show-search" data-placeholder="Select Case Category">
                                            ...
                                            <option value="{{ $item->id }}"{{ $item->id == $lastest->casecat_id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mg-t-20">
                                    ...
                                    <div class="col-sm-2">
                                        <img src="{{ asset($lastest->image) }}" width="80" id="mainThmb">
                                    </div>
                                </div>
